...
class MemoryGame:
    def _init_(self, root, num_pairs):
        self.root = root
        ...
        self.selected = []
        self.pairs_found = 0
        self.default_image = ImageTk.PhotoImage(Image.new('RGB', (160, 160), 'grey'))
        self.load_images()
    ...
    def set_default_images(self):
        default_image_paths = [
            "C:/Users/AriRubio/Documents/Prolog/sandia.png",
            "C:/Users/AriRubio/Documents/Prolog/pera.png",
            "C:/Users/AriRubio/Documents/Prolog/manzana.png",
            "C:/Users/AriRubio/Documents/Prolog/uvas.png"
        ]
    ...
    def show_victory_screen(self):
        ...
        self.play_gif(background_label, "C:/Users/AriRubio/Documents/Prolog/victoria.gif")
        ...
        pygame.init()
        pygame.mixer.music.load("C:/Users/AriRubio/Documents/Prolog/victoria_happy_wheels.mp3")
        pygame.mixer.music.play()

        # Botón para cerrar la ventana y reiniciar el juego
        close_button = tk.Button(victory_window, text="Cerrar", command=lambda: [victory_window.destroy(), self.reset_game()])
...
class QuickMemoryGame(MemoryGame):
    def _init_(self, root, difficulty='normal'):
        super()._init_(root, 4)
    ...
    def show_defeat_screen(self):
        if not self.game_over:
            ...
            background_label.place(x=0, y=0, relwidth=1, relheight=1)
            self.play_gif(background_label, "C:/Users/AriRubio/Documents/Prolog/derrota.gif")

        background_label.place(x=0, y=0, relwidth=1, relheight=1)


        # Agregar un mensaje de victoria
        victory_label = tk.Label(defeat_window, text="Has Perdido! Suerte para la próxima (;", font=("Arial", 24), bg="white")
        victory_label.pack(pady=50)

        # Reproducir música de fondo
        pygame.init()
        pygame.mixer.music.load("C:/Users/AriRubio/Documents/Prolog/Game Over 8bit.mp3")
        pygame.mixer.music.play()

        # Botón para cerrar la ventana y reiniciar el juego
        close_button = tk.Button(defeat_window, text="Cerrar", command=lambda: [defeat_window.destroy(), self.reset_game()])
        close_button.pack(pady=20)
        pass
...
class StartMenu:
    def _init_(self, master):
        ...
        self.song_list = [
            "C:/Users/AriRubio/Documents/Prolog/Local Forecast.mp3",
            "C:/Users/AriRubio/Documents/Prolog/The Legend of Zelda_ Ocarina of Time - Shop Theme Cover.mp3",
            "C:/Users/AriRubio/Documents/Prolog/Gymnopedie No.1 Bossa ver.mp3"
        ]

        # Cargar y mostrar una imagen de fondo
        self.background_image = Image.open("C:/Users/AriRubio/Documents/Prolog/Chibi_monos.jpeg")
